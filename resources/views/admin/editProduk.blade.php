                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditProduk/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Nama ikan</label>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="number" class="form-control border border-secondary form-control" name="harga" required value="{{ $data->harga }}">
                                <span class="text-danger">
                                    @error('harga')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Ketersediaan</label>
                                <input type="text" class="form-control border border-secondary form-control" name="stok" required value="{{ $data->stok }}">
                                <span class="text-danger">
                                    @error('stok')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Tanggal Penangkapan</label>
                                <input type="date" class="form-control border border-secondary form-control" name="tanggal_penangkapan" required value="{{ $data->tanggal_penangkapan }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <div class="form-text">Maksimal ukuran gambar Gambar 5MB</div>
