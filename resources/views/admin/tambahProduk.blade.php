        ...
        <div class="row">
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Tambah Data ikan</h5>
                        <form action="{{ route('posttambahProduk') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary form-control" name="stok" required value="{{ old('stok') }}">
                                <span class="text-danger">
                                    @error('stok')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tanggal_penangkapan" required value="{{ old('tanggal_penangkapan') }}">
                                <span class="text-danger">
