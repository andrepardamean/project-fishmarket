                ...
                <div class="col-11">
                    <nav class="main-nav">
                        ...
                        <ul class="nav ms-auto">
                            <li><a href="{{ route('user.home') }}" class="active">Beranda</a></li>
                ...
                <div class="col-lg-4 ">
                    <div class="trainer-item">
                        ...
                        <div class="down-content m-4">
                            <h4>Jenis Ikan</h4>
                            <p>
                                Disini Kami menyediakan berbagai jenis ikan hasil tangkapan nelayan
                ...
                <div class="col-lg-4 ">
                    <div class="trainer-item">
                        ...
                        <div class="down-content m-4">
                            <h4>Jenis Udang</h4>
                            <p>
                                Disini Kami juga menyediakan jenis udang hasil tangkapan nelayan
                            </p>
                        </div>
                    </div>
                </div>
